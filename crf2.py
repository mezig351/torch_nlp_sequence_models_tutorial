...
class CRF(nn.Module):
    ...
    def init_hidden(self, batch_length=1):
        # return (torch.randn(2, 1, self.hidden_dim // 2),
        #         torch.randn(2, 1, self.hidden_dim // 2))
        return (torch.zeros(2, batch_length, HIDDEN_DIM // 2),
                torch.zeros(2, batch_length, HIDDEN_DIM // 2))
